...
/*   Updated: 2022/05/12 14:51:27 by bvarlamo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::signForm(Form& obj){
	...
	{
		std::cout << this->_name << " couldnt sign " << obj.getName() << " because: " <<  e.what() << std::endl;
	}
}
...
void	Bureaucrat::executeForm(Form const & form){
	...
	{
		std::cout << this->_name << " couldnt execute " << form.getName() << " because: " <<  e.what() << std::endl;
	}
}